...
public class UploadData {
    ...
    @FindBy(xpath = "//div[@id='tl_upload_newdialog-123-52056']")
    WebElement txtInformasi_yakinmenyimpan;

    @FindBy(id= "52057_query")
    WebElement btnsimpan1;
    ...
    public String getTxtInformasi_yakinmenyimpan() {
        return txtInformasi_yakinmenyimpan.getText();
    }
    ...
    public void Click_btn_Informasi_menyimpan() {
        btnsimpan1.click();
    }
