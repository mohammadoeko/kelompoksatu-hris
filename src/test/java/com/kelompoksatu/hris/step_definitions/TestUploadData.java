...
public class TestUploadData {
    ...
    public void tcc_tele_002_klik_data() {
        driver.get(Constants.URL);
        uploadData.formLogin("developer", "23");
        uploadData.btnOkWelcome();
        uploadData.clickData();
    ...
    public void tcc_tele_003_klik_data_simpan() {
        driver.get(Constants.URL);
        uploadData.btnOkWelcome();
        uploadData.clickData();
    ...
    public void tcc_tele_003_menampilkan_popup_data_kosong() {
        hooks.waiting(3);
    ...
    public void tcc_tele_004_klik_data_untuk_file_txt() {
        driver.get(Constants.URL);
        uploadData.btnOkWelcome();
        uploadData.clickData();
    ...
    public void tcc_tele_004_klik_menu_upload_data_untuk_file_txt() {
        uploadData.clickMenuBtnUploadData();
        extentTest.log(LogStatus.PASS,"Klik upload data untuk file txt");
    }

    @And("TCC.Tele.004 import file txt")
    public void tcc_tele_004_import_file_txt() {
    ...
    public void tcc_tele_004_klik_button_upload_untuk_file_txt() {
        uploadData.clickBtnUpload();
        extentTest.log(LogStatus.PASS, "klik button upload untuk file txt");
    }

    @Then("TCC.Tele.004 Menampilkan popup file tidak dapat dibaca\\/jumlah data untuk file txt")
    public void tcc_tele_004_menampilkan_popup_file_tidak_dapat_dibaca_jumlah_data_untuk_file_txt() {
        hooks.waiting(3);
        Assert.assertEquals(uploadData.getTxtInformasiUpload(), "File tidak dapat dibaca/ jumlah data 0");
    ...
    public void tcc_tele_005_klik_data_simpan_file_txt() {
        driver.get(Constants.URL);
        uploadData.btnOkWelcome();
        uploadData.clickData();
    ...
    public void tcc_tele_005_menampilkan_popup_data_kosong_file_txt() {
        hooks.waiting(4);
        Assert.assertEquals(uploadData.getTxtInformasiSimpan(), "Data Kosong");
