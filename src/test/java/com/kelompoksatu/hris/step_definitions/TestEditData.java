...
public class TestEditData {
    ...
    public void tcc_tele_001_klik_distribute_data() {
    ...
    public void tcc_tele_001_menampilkan_halaman_distribusi() {
    ...
    public void tcc_tele_002_edit_data_klik_data() {
        driver.get(Constants.URL);
        uploadData.btnOkWelcome();
        editData.clickData();
        extentTest.log(LogStatus.PASS,"klik data");
    ...
    public void tcc_tele_003_edit_data_klik_data() {
        driver.get(Constants.URL);
        uploadData.btnOkWelcome();
        editData.clickData();
        extentTest.log(LogStatus.PASS,"klik data");
